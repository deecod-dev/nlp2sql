...
SECRET_KEY = 'django-insecure-*4yf^3w_k)vd%1d0q4#h+9&!zj&so77)vqk2@s$uk3l_wu!-#h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['nlp2sql-4.onrender.com', 'localhost', '127.0.0.1']
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dataquery/static'),
]
